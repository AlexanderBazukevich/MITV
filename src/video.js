...
function activate(e) {
    showNeighbours(e.previousElementSibling, e.nextElementSibling);
...
function showNeighbours(left, right) {
    left.classList.remove('video__item_hidden');
    right.classList.remove('video__item_hidden');
}
